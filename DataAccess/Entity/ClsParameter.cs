...
namespace DataAccess.Entity
{
    public class ClsParameter
    {
        ...
        // constructor
        // entrada
        public ClsParameter(String objNombre, Object objValor)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
        ...
        public ClsParameter(String objNombre, Object objValor, SqlDbType objTipoDato, ParameterDirection objDireccion, int objTamaño)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
